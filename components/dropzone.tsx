          ...
          >
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="flex items-center gap-1 w-96">
                <span className="text-md text-gray-700 dark:text-gray-700 font-medium overflow-x-hidden">
            ...
            {action.is_error ? (
              ...
              <div className="text-muted-foreground text-md flex items-center gap-4 shadow-sm">
  ...
  return (
    ...
    >
      {({ getRootProps, getInputProps }) => (
        <div
          {...getRootProps()}
          className="border border-gray-500 bg-background h-72 lg:h-80 xl:h-96 rounded-3xl shadow-sm border-secondary border-2 border-dashed cursor-pointer flex items-center justify-center"
        >
          <input {...getInputProps()} />
